...
gtx = 'cas2k_v2_x2b'
infile = 'f2017.09.26' # the date in WCOA2017
transect = 'NHL'
fn = Ldir['roms_out'] / gtx / infile / 'ocean_his_0002.nc'

out_dir =Ldir['LOo'] / 'plots' / 'section' 
...
x_e = np.linspace(-124, -127, 500)
y_e = 44.652 * np.ones(x_e.shape)
...
ff_str = f'{transect}_{infile}_{gtx}_{vn}_mod'
